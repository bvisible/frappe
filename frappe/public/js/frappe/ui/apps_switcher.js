...
//// ui/apps_switcher.html and scss/desk/sidebar.scss (all marked). It renders frappe.boot.app_data
//// (served by frappe/boot.py, same commit) as a dropdown at the top of the sidebar, and
